...
$br_dtl = selects("tb_borrow_dtl","where br_no = '$br[br_no]'");
$ret_data = select("tb_user ur inner join department dp on ur.dept_id = dp.dept_id","where ur.user_id = '$br[ret_emp]'");
