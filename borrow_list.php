...
<div id="tabs">
  ...
  <div id="tabs-1">
    ...
    <tr>
      ...
      <option value="1" <?=$sel = ($_POST['selby_status'] == '1' ? 'selected' : '');?>>รอการตรวจสอบจากแผนก</option>
      <option value="2" <?=$sel = ($_POST['selby_status'] == '2' ? 'selected' : '');?>>รอการตรวจสอบจาก DCC</option>
      <option value="3" <?=$sel = ($_POST['selby_status'] == '3' ? 'selected' : '');?>>อนุมัติ</option>
      <option value="4" <?=$sel = ($_POST['selby_status'] == '4' ? 'selected' : '');?>>ไม่อนุมัติ</option>
      </select>
      </td>
      ...
      <td>
        <select name="selby_return" class="wt" id="selby_return">
          <option value="">---- เลือก ----</option>
          <option value="NO" <?=$sel = ($_POST['selby_return'] == 'NO' ? 'selected' : '');?>>ยังไม่ได้คืนเอกสาร</option>
          <option value="CK" <?=$sel = ($_POST['selby_return'] == 'CK' ? 'selected' : '');?>>คืนเอกสารไม่ครบ</option>
          <option value="OK" <?=$sel = ($_POST['selby_return'] == 'OK' ? 'selected' : '');?>>คืนเอกสารแล้ว</option>
          </select>
      </td>
      </tr>
    <tr>
      ...
      <td width="35%"><select name="sel_by" class="wt" id="sel_by">
        <option value="">---- เลือก ----</option>
        <option value="br_no" <?=$sel = ($_POST['sel_by'] == 'br_no' ? 'selected' : '');?>>เลขที่อ้างอิง</option>
        <option value="dept_id" <?=$sel = ($_POST['sel_by'] == 'dept_id' ? 'selected' : '');?>>แผนก / หน่วยงาน</option>
        <option value="br_date" <?=$sel = ($_POST['sel_by'] == 'br_date' ? 'selected' : '');?>>วันที่ทำการยืมเอกสาร</option>
      </select></td>
