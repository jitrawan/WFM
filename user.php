...
<table width="50%" border="0" align="center" cellpadding="3" cellspacing="3">
  ...
  <tr>
    ...
    <select class="span5" id="dept_id" name="dept_id">
        ...
        <?
            $opt = selects("department","where 1=1 order by dept_id");
                foreach($opt as $v){
            ?>
  ...
  <tr>
    ...
    <select class="span5" id="g_id" name="g_id">
        ...
        <?
            $opt = selects("tb_guser","where 1=1 order by g_id");
                foreach($opt as $v){
            ?>
...
<tbody>
<?PHP
	$sql=selects("tb_user un inner join department dp on un.dept_id=dp.dept_id inner join tb_guser gu on un.g_id=gu.g_id","where 1=1 order by un.firstname");
	foreach($sql as $data){
